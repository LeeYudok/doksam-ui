...
export const PIPELINE_SAMPLES: PatternSampleData[] = [
  {
    num: 33,
    title: "스텝 플로우",
    description: "번호 + 화살표 + 상태 아이콘 + 진행률 바.",
    demo: <StepFlow />,
    code: STEP_FLOW_CODE,
    notes: [
  ...
  },
  {
    num: 34,
    title: "실행 상태 배지",
    description: "Running/Success/Failed/Stopped 4종 — 시맨틱 토큰으로 다크모드 자동 대응.",
    demo: <StatusBadgeShowcase />,
  ...
  },
  {
    num: 35,
    title: "툴팁 액션 버튼",
    description: "모든 아이콘 전용 버튼에 Tooltip 필수 — 접근성 라벨 겸용.",
    demo: <TooltipActionButtons />,
    code: TOOLTIP_CODE,
    notes: [
  ...
  },
  {
    num: 36,
    title: "스텝 카드 그리드",
    description: "카테고리 배지 + 카테고리별 스텝 카드, 상태별 아이콘/에러 메시지.",
    demo: <StepCardGrid />,
  ...
  },
  {
    num: 37,
    title: "수집 이력 테이블",
    description: "상태별 행 하이라이팅 + 체크박스 일괄선택 + 인라인 Tooltip 액션.",
    demo: <CollectionHistoryTable />,
  ...
  },
  {
    num: 38,
    title: "스텝 결과 리스트",
    description: "순번 + 스텝명 + 건수 + 소요시간, 하단 자동 합산.",
    demo: <StepResultList />,
  ...
  },
  {
    num: 39,
    title: "고급 데이터 테이블",
    description: "필터 + 정렬 헤더 + 일괄 선택 + 페이징 — 목록 화면 표준 툴바.",
    demo: <AdvancedDataTable />,
  ...
  },
  {
    num: 40,
    title: "에러 카드 + 실행 로그",
    description: "실패/경고 알림 카드와 최근 실행 이력 리스트.",
    demo: <ErrorAndLog />,
    code: ERROR_LOG_CODE,
    notes: [
