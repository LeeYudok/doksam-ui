...
export const RULES_SECTIONS: RulesSection[] = [
  ...
  },
  {
    ...
    kind: "invariant",
    items: [
      "하드코딩 색(hex, rgb, 임의 OKLCH 값 등)을 직접 쓰지 않는다 — 항상 시맨틱 토큰만 사용한다: themes/ 의 프리셋 27키(bg-background, text-primary 등)와 globals.css 의 :root/.dark 가 소유한 보조 층(sidebar-*, risk-*)이다.",
